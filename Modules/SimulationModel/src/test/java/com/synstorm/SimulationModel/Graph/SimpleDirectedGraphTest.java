...
public class SimpleDirectedGraphTest {
    ...
    public void testDeleteAndAdd() {
        ...
        GraphVertex v = new GraphVertex(123);
        vertices.add(v);
        g.vertexAdd(v);
    ...
    public void testEdgeCreateWorks() {
        ...
        g.edgeCreate(GraphEdge.integerEdge(1, 0));
        Assert.assertTrue(g.edgePresent(GraphEdge.integerEdge(0, 1)));
        Assert.assertTrue(g.edgePresent(GraphEdge.integerEdge(1, 0)));
    ...
    @Test
    public void thousandVerticesAdd() {
        SimpleDirectedGraph g = new SimpleDirectedGraph(true);
    ...
    protected void initGraph(boolean connected) {
        g = new SimpleDirectedGraph(connected);
        for (int i = 0; i < testVerticesNumber; i++) {
            GraphVertex v = new GraphVertex(i);
            vertices.add(v);
            g.vertexAdd(v);
